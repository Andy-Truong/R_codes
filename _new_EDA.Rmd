...
```
daterequested, datecreated, actualcompletiondate, laststatuschange, currentstatus, prioritydescription, ispreventmaint, ymrequested, ymcomplete
```{r priorityts}
priority = requested %>% select(craftdescription, craftgroup, d) %>%
